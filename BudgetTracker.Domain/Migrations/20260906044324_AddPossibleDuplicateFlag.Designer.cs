...
namespace BudgetTracker.Domain.Migrations
{
    ...
    [Migration("20260906044324_AddPossibleDuplicateFlag")]
    partial class AddPossibleDuplicateFlag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetTracker.Domain.Models.Transaction", b =>
                {
                    ...
                    b.Property<int?>("PossibleDuplicateOfId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PossibleDuplicateOfId")
                        .HasDatabaseName("IX_Transactions_PossibleDuplicateOf")
                        .HasFilter("[PossibleDuplicateOfId] IS NOT NULL");
            ...
            modelBuilder.Entity("BudgetTracker.Domain.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("BudgetTracker.Domain.Models.Transaction", null)
                        .WithMany()
                        .HasForeignKey("PossibleDuplicateOfId")
                        .OnDelete(DeleteBehavior.NoAction);
